...
import {fetchAndDisplayFile, get, post, uploadFile} from "@/net/index.js";
  ...
  <el-row>
    ...
    <div id="personal_l" v-loading="(form.avatarLoading&&form.dataLoading)">
      ...
      <div v-if="props.person">
        ...
        <span style="color:deepskyblue;font-size: 18px">
          重置密码
        </span>
            ...
            >
              ...
              <el-form-item label="确认密码" prop="new_password_repeat">
                <el-input
                    ...
                    clearable
                    placeholder="重新输入新密码"
                    v-model="passwordForm.new_password_repeat"
                />
              </el-form-item>
            </el-form>
          </div>
        </div>
        <el-button type="success" @click="resetPassword">
          立即重置密码
        </el-button>
      </div>
      <div v-if="!props.person">
